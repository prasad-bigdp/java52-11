...
function myFun(str){
let arr = str.split('');count=0;
  arr.forEach((e, i) =>
  {
    if (e.toLowerCase() == 'a' || e.toLowerCase() == 'e')// need to add i,o,u also
    { count++ }
  });
  return count;
};let x= myFun("prasad");console.log(x)
//write a function that accepts name,age,email of a person as parameters and add them in an existing array
// students =[] , addStudent("raj",25,"a@a.com")
// students = [{name:"raj",age:25,email:"a@a.com"}]
function addStudent (n, a, e)
{
  let obj = {
